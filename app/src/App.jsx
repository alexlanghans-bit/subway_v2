...
const phaseData = {
  ...
  phases: [
    ...
    },
    {
      ...
      years: '3-6',
      status: 'upcoming',
      storeStart: '17,000-18,000',
      storeEnd: '14,500-15,500',
      storeEndNum: 15000,
    ...
    },
    {
      ...
      years: '6-10',
      status: 'future',
      storeStart: '14,500-15,500',
      storeEnd: '12,000-14,000',
      storeEndNum: 13000,
...
const newDevelopmentData = {
  ...
  overdevelopmentLesson: {
    ...
    stats: '25,000+ stores at peak → 20,000 today → 12-14k target by 2035',
  ...
  communityEngagement: {
    ...
    keystoneEnhancements: [
      ...
      },
      {
        ...
        benefit: 'Leverage collective wisdom of 20,000+ operators'
      },
    ],
...
const comebackTrackerData = {
  ...
  tagline: 'Radical Transparency at 20,000+ Locations',
  ...
  weeklyProgress: [
    { week: 'Week 1', rate: 68, stores: 18500 },
    { week: 'Week 2', rate: 70, stores: 18200 },
    { week: 'Week 3', rate: 72, stores: 17800 },
    { week: 'Week 4', rate: 74, stores: 17500 },
  ],
  topStores: [
  ...
  sections: [
    ...
    },
    {
      ...
      risks: [
        ...
        { risk: '"What if we look bad?"', solution: 'Right-size to 12-16k elite stores first' },
      ],
    },
  ],
...
const implementationRoadmapData = [
  ...
  },
  {
    ...
    quarters: [
      ...
      { q: 'Y6', focus: 'Network Optimization', actions: ['Reach ~15,000 stores', 'Food OS 2.0 national', 'Full loyalty reimagination'] },
    ],
  },
  {
    phase: 3,
    ...
    quarters: [
      ...
      { q: 'Y9-10', focus: 'Institutionalization', actions: ['Reach 12-16k elite stores', 'Food OS 3.0 with AI', '5%+ corporate spine', 'Model fully institutionalized'] },
    ],
  },
]
...
const presentationSlides = [
  {
    ...
    subtitle: '12-16k Elite Units in 10 Years',
    content: 'A strategic reset from 20,000 inconsistent stores to a right-sized network of profitable, modern, community-connected locations.',
    type: 'title',
  },
  {
    id: 2,
    ...
    content: 'Open-source our performance metrics to customers. Every store\'s Success Rate, Order Accuracy, Freshness scores — visible to anyone. At 20,000+ locations. In real-time.',
  ...
  },
  {
    ...
    bullets: [
      '12-16k stores that are profitable, modern, and community-connected',
